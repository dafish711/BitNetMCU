...
class CNN_Olivetti(nn.Module):
    """
    CNN+FC Neural Network for Olivetti Faces dataset. Depthwise separable convolutions.
    16x16 input image, 3 hidden layers with a configurable width.

    Adapted from CNNMNIST for 40-class face classification.
    """
    def __init__(self,network_width1=64,network_width2=64,network_width3=64,cnn_width=64,QuantType='Binary',WScale='PerTensor',NormType='RMS', num_classes: int = 40):
        super(CNN_Olivetti, self).__init__()
...
class FC_Olivetti(nn.Module):
    """
    Fully Connected Neural Network for Olivetti Faces dataset.
    16x16 input image, 3 hidden layers with a configurable width.

    @cpldcpu 2024-March-24

    """
    def __init__(self,network_width1=64,network_width2=64,network_width3=64,QuantType='Binary',WScale='PerTensor',NormType='RMS', num_classes: int = 40):
        super(FC_Olivetti, self).__init__()
